...
struct Interop_GHIElectronics_TinyCLR_Native_GHIElectronics_TinyCLR_Native_Power {
    ...
    static TinyCLR_Result SetLevel___STATIC___VOID__GHIElectronicsTinyCLRNativePowerLevel__GHIElectronicsTinyCLRNativePowerWakeSource__U8(const TinyCLR_Interop_MethodData md);
};
