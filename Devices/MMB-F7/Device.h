...
#define DEVICE_VERSION ((0ULL << 48) | (12ULL << 32) | (0ULL << 16) | (0ULL << 0)) // 0.8.0.0
...
#define INCLUDE_UART
#define STM32F7_UART_DEFAULT_TX_BUFFER_SIZE  { 256, 256 } // new from 0.8.0
#define STM32F7_UART_DEFAULT_RX_BUFFER_SIZE  { 512, 512 } // new from 0.8.0
