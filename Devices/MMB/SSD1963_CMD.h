...
/*********************************************************************
* Overview: Some basic colors definitions. 16 bits
*********************************************************************/
...
#define Set_Cs  STM32F4_GpioInternal_WritePin(PIN(F, 13), true); // GPIO_SetBits(GPIOF,GPIO_Pin_13);
#define Clr_Cs  STM32F4_GpioInternal_WritePin(PIN(F, 13), false); //GPIO_ResetBits(GPIOF,GPIO_Pin_13);

#define Set_Rs  STM32F4_GpioInternal_WritePin(PIN(F, 15), true); //GPIO_SetBits(GPIOF,GPIO_Pin_15);
#define Clr_Rs  STM32F4_GpioInternal_WritePin(PIN(F, 15), false); //GPIO_ResetBits(GPIOF,GPIO_Pin_15);

#define Set_nWr STM32F4_GpioInternal_WritePin(PIN(F, 11), true); //GPIO_SetBits(GPIOF,GPIO_Pin_11);
#define Clr_nWr STM32F4_GpioInternal_WritePin(PIN(F, 11), false); //GPIO_ResetBits(GPIOF,GPIO_Pin_11);

#define Set_nRd STM32F4_GpioInternal_WritePin(PIN(F, 12), true); //GPIO_SetBits(GPIOF,GPIO_Pin_12);
#define Clr_nRd STM32F4_GpioInternal_WritePin(PIN(F, 12), false); //GPIO_ResetBits(GPIOF,GPIO_Pin_12);

#define Set_Rst STM32F4_GpioInternal_WritePin(PIN(F, 14), true); //GPIO_SetBits(GPIOF,GPIO_Pin_14);
#define Clr_Rst STM32F4_GpioInternal_WritePin(PIN(F, 14), false); //GPIO_ResetBits(GPIOF,GPIO_Pin_14);
