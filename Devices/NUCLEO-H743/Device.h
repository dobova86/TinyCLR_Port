...
#define DEBUGGER_FORCE_API STM32H7_UsbClient_GetApi()
//#define DEBUGGER_FORCE_API STM32H7_Uart_GetApi()
...
#define STM32H7_SYSTEM_CLOCK_HZ 216000000	 // 168000000 // 180000000 // 216000000
#define STM32H7_AHB_CLOCK_HZ	216000000	 // 168000000 // 180000000 // 216000000
#define STM32H7_APB1_CLOCK_HZ	54000000	 // 42000000  // 45000000  //  54000000
#define STM32H7_APB2_CLOCK_HZ	108000000	 // 84000000  // 90000000 //  108000000
...
#define STM32H7_UART_RX_PINS  { { PIN_NONE , AF_NONE }, { PIN(D,  6), AF(7)  },{ PIN(D, 9) , AF(7) },{ PIN_NONE , AF_NONE },{ PIN_NONE , AF_NONE }, { PIN(G, 9), AF(8) } }
#define STM32H7_UART_CTS_PINS { { PIN_NONE , AF_NONE }, { PIN(D,  3), AF(7)  },{ PIN_NONE , AF_NONE },  { PIN_NONE , AF_NONE }, { PIN_NONE , AF_NONE }, { PIN_NONE, AF_NONE } }
#define STM32H7_UART_RTS_PINS { { PIN_NONE , AF_NONE }, { PIN(D,  4), AF(7)  },{ PIN_NONE , AF_NONE },  { PIN_NONE , AF_NONE }, { PIN_NONE , AF_NONE }, { PIN_NONE, AF_NONE } }

#define INCLUDE_USBCLIENT
#define STM32H7_TOTAL_USB_CONTROLLERS	1
#define STM32H7_USB_PACKET_FIFO_COUNT	64
#define STM32H7_USB_ENDPOINT_SIZE		64
#define STM32H7_USB_ENDPOINT0_SIZE		8
#define STM32H7_USB_ENDPOINT_COUNT		4
#define STM32H7_USB_PIPE_COUNT			4

#define STM32H7_USB_DM_PINS { { PIN(A, 11), AF(10) } }
#define STM32H7_USB_DP_PINS { { PIN(A, 12), AF(10) } }
#define STM32H7_USB_VB_PINS { { PIN(A,  9), AF(10) } }
#define STM32H7_USB_ID_PINS { { PIN(A, 10), AF(10) } }

#define INCLUDE_RTC

#define INCLUDE_SD	// SD connectione are on CN8 (no embedded socket on nucleo)
#define STM32H7_SD_DATA0_PINS { { PIN(C, 8), AF(12) } }
#define STM32H7_SD_DATA1_PINS { { PIN(C, 9), AF(12) } }
#define STM32H7_SD_DATA2_PINS { { PIN(C,10), AF(12) } }
#define STM32H7_SD_DATA3_PINS { { PIN(c,11), AF(12) } }
#define STM32H7_SD_CLK_PINS   { { PIN(C,12), AF(12) } }
#define STM32H7_SD_CMD_PINS   { { PIN(D, 2), AF(12) } }
