...
static TinyCLR_Api_Manager displayApi;
...
TinyCLR_Result STM32F7_DsiDisplay_Acquire(const TinyCLR_Display_Controller* self, int32_t controller) {
...
TinyCLR_Result STM32F7_DsiDisplay_Release(const TinyCLR_Display_Controller* self, int32_t controller) {
...
TinyCLR_Result STM32F7_DsiDisplay_Enable(const TinyCLR_Display_Controller* self, int32_t controller) {
...
TinyCLR_Result STM32F7_DsiDisplay_Disable(const TinyCLR_Display_Controller* self, int32_t controller) {
	return TinyCLR_Result::NotSupported;
}

TinyCLR_Result STM32F7_DsiDisplay_SetConfiguration(const TinyCLR_Display_Controller* self, int32_t controller, TinyCLR_Display_DataFormat dataFormat, uint32_t width, uint32_t height, const void* configuration) { //(const TinyCLR_Display_Provider* self, TinyCLR_Display_DataFormat dataFormat, uint32_t width, uint32_t height, const void* configuration) {
	...
	if (configuration != nullptr) {
		...
		m_STM32F7_Display_VituralRam = (uint16_t*)UNCACHE_LCD_BUFFER_ADDRESS;
...
TinyCLR_Result STM32F7_DsiDisplay_GetConfiguration(const TinyCLR_Display_Controller* self, int32_t controller, TinyCLR_Display_DataFormat& dataFormat, uint32_t& width, uint32_t& height, void* configuration) { //(const TinyCLR_Display_Provider* self, TinyCLR_Display_DataFormat& dataFormat, uint32_t& width, uint32_t& height, void* configuration) {
...
TinyCLR_Result STM32F7_DsiDisplay_DrawBuffer(const TinyCLR_Display_Controller* self, int32_t controller, int32_t x, int32_t y, int32_t width, int32_t height, const uint8_t* data) { //(const TinyCLR_Display_Provider* self, int32_t x, int32_t y, int32_t width, int32_t height, const uint8_t* data) {
	STM32F7_Display_BitBltEx(x, y, width, height, (uint32_t*)data);
	return TinyCLR_Result::Success;
}

TinyCLR_Result STM32F7_DsiDisplay_WriteString(const TinyCLR_Display_Controller* self, int32_t controller, const char* buffer, size_t length) { //(const TinyCLR_Display_Provider* self, const char* buffer, size_t length) {
...
TinyCLR_Result STM32F7_DsiDisplay_GetCapabilities(const TinyCLR_Display_Controller* self, int32_t controller, TinyCLR_Display_InterfaceType& type, const TinyCLR_Display_DataFormat*& supportedDataFormats, size_t& supportedDataFormatCount) {  //(const TinyCLR_Display_Provider* self, TinyCLR_Display_InterfaceType& type, const TinyCLR_Display_DataFormat*& supportedDataFormats, size_t& supportedDataFormatCount) {
...
const TinyCLR_Display_Controller* STM32F7_DsiDisplay_GetApi() {
