...
// default to RK043
uint32_t m_STM32F7_DisplayWidth = 480;
uint32_t m_STM32F7_DisplayHeight = 272;
...
void STM32F7_WriteHello()
{
    ...
    char buffer[] = "\nDiscovery DISC0-STM32F746NG Display driver\n";
...
bool STM32F7_Display_Initialize() {
    ...
    */
    ...
    /* Configure the Layer*/
    STM32F7_Ltdc_LayerConfiguration(&hltdc_F, &pLayerCfg, 0);
...
TinyCLR_Result STM32F7_Display_Enable(const TinyCLR_Display_Provider* self) {
    ...
    //if (STM32F7_Display_Initialize() && STM32F7_Display_SetPinConfiguration()) {
    //    return TinyCLR_Result::Success;
    //}
