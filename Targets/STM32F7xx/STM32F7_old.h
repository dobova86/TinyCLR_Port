...
TinyCLR_Result STM32F7_Time_GetInitialTime(const TinyCLR_Time_Provider* self, int64_t& utcTime, int32_t& timeZoneOffsetMinutes);
...
TinyCLR_Result STM32F7_Can_Reset(const TinyCLR_Can_Provider* self);
...
TinyCLR_Result STM32F7_UsbClient_Open(const TinyCLR_UsbClient_Provider* self, int32_t& stream, TinyCLR_UsbClient_StreamMode mode);
TinyCLR_Result STM32F7_UsbClient_Close(const TinyCLR_UsbClient_Provider* self, int32_t stream);
TinyCLR_Result STM32F7_UsbClient_Write(const TinyCLR_UsbClient_Provider* self, int32_t stream, const uint8_t* data, size_t& length);
TinyCLR_Result STM32F7_UsbClient_Read(const TinyCLR_UsbClient_Provider* self, int32_t stream, uint8_t* data, size_t& length);
TinyCLR_Result STM32F7_UsbClient_Flush(const TinyCLR_UsbClient_Provider* self, int32_t stream);
...
TinyCLR_Result STM32F7_Display_Acquire(const TinyCLR_Display_Provider* self, uint32_t width, uint32_t height);
TinyCLR_Result STM32F7_Display_Release(const TinyCLR_Display_Provider* self);
TinyCLR_Result STM32F7_Display_SetLcdConfiguration(const TinyCLR_Display_Provider* self, bool outputEnableIsFixed, bool outputEnablePolarity, bool pixelPolarity, uint32_t pixelClockRate, bool horizontalSyncPolarity, uint32_t horizontalSyncPulseWidth, uint32_t horizontalFrontPorch, uint32_t horizontalBackPorch, bool verticalSyncPolarity, uint32_t verticalSyncPulseWidth, uint32_t verticalFrontPorch, uint32_t verticalBackPorch);
TinyCLR_Result STM32F7_Display_DrawBuffer(const TinyCLR_Display_Provider* self, int32_t x, int32_t y, int32_t width, int32_t height, const uint8_t* data, TinyCLR_Display_Format dataFormat);
TinyCLR_Result STM32F7_Display_WriteString(const TinyCLR_Display_Provider* self, const char* buffer);
int32_t STM32F7_Display_GetWidth(const TinyCLR_Display_Provider* self);
int32_t STM32F7_Display_GetHeight(const TinyCLR_Display_Provider* self);
TinyCLR_Display_InterfaceType STM32F7_Display_GetType(const TinyCLR_Display_Provider* self);
